...
User will type answer instaed of options a,b,c,d
...
#qusetion list
QUESTION_LIST = ['answer_type_quiz']
...
def post_question(question):
    ...
    while(True):
        ...
        answer = input("Enter answer proper answer: ")
...
def play_quiz():
    ...
    flag = False
    if not flag:
        questions = load_question('questions/answer_type_quiz.json')
        take_test(questions)
    else:
        play_quiz()
